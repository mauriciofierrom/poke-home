...
, dialogflow-fulfillment, http-client, http-client-tls, mtl
, pokeapi, servant, servant-client, servant-server, stdenv, text
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    aeson base bytestring containers dialogflow-fulfillment http-client
  ...
  executableHaskellDepends = [
    ...
    pokeapi servant servant-client servant-server text transformers
